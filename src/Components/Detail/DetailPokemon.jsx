  ...
  return (
    <div className={style.detailContainer}>
      ...
      <div className={style.dataContainer}>
        <p>
          <span>Type:</span> {detail.types}
        </p>
        <p>
          <span>Height:</span> {detail.height}
        </p>
        <p>
          <span>Weight:</span> {detail.weight}
        </p>
        <p>
          <span>Life:</span> {detail.hp || detail.life}
        </p>
        <p>
          <span>Defense:</span> {detail.defense}
        </p>
        <p>
          <span>Speed:</span> {detail.speed}
        </p>
        <p>
          <span>Attack:</span> {detail.attack}
        </p>
      </div>
    </div>
  );
